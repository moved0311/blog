...
1.  Degree centrality  
    ...
    ![degreeCentrality](/images/2017-02-25-degreeCentrality01.png)
    但 degree centrality 的缺點是如果有一個點的 degree 很低,
    但是這個點連接了多個 community,
    用 degree centrality 看不出這個點很重要

![degreeCentrality](/images/2017-02-25-degreeCentrality02.png)
...
![clique img](/images/2017-02-25-community01.png)
...
![Information Diffusion](/images/2017-02-25-InformationDiffusion.png)
