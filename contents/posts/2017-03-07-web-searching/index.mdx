...
- [Multinomial model](https://en.wikipedia.org/wiki/Multinomial_distribution)  
   ![multinomial Distribustion](/images/2017-03-07-MultinomialDistribution.png)
...
example:
k = 3
![kNN = 3](/images/2017-03-07-kNN3.png)
...
目標是找到最大的$\rho$
![svm01](/images/2017-03-07-svm01.png)
...
![svm02](/images/2017-03-07-svm02.png)
