...
| ---------------------------------------------------------------------------------- | ----------------------------------------------------------------------------- |
| <img src="/images/posts/2024-04-02-tradingview/2024-04-02-lightweight-charting.png" style={{height:'300px'}} /> | <img src="/images/posts/2024-04-02-tradingview/2024-04-02-charting_library.png" style={{height:'300px'}}/> |
...
2. 從[charting_library](https://github.com/tradingview/charting_library/)下載`charting_library` 與 `datafeeds` 放到`/public`下
   ...
   <img src="/images/posts/2024-04-02-tradingview/2024-04-02-put-to-public.png" alt="static-files" width="600" />
...
- symbol: symbol 格式可以根據 API 不同來做改變
  ...
  <img src="/images/posts/2024-04-02-tradingview/2024-04-02-AAPL.png" alt="tradingview-first-example" width="400" />
...
<img src="/images/posts/2024-04-02-tradingview/2024-04-02-flow.png" alt="flow" />
