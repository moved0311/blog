...
const Page = async ({ params }: PageProps) => {
  ...
  return (
    <div className="dark:text-white">
      ...
      <article className="prose scroll-smooth md:prose-lg dark:prose-invert prose-a:no-underline prose-th:text-center prose-li:m-0 prose-ul:m-0 prose-ol:m-0 prose-h1:mt-4 prose-h1:scroll-mt-24 prose-h2:mb-2 prose-h2:scroll-mt-24 prose-table:w-auto prose-td:text-center">
        <Content />
      </article>
    </div>
  );
