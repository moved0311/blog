...
1.  Degree centrality  
    ...
    ![degreeCentrality](/2017-02-25-cloudComputing/degreeCentrality01.png)
    但 degree centrality 的缺點是如果有一個點的 degree 很低,
    但是這個點連接了多個 community,
    用 degree centrality 看不出這個點很重要

![degreeCentrality](/2017-02-25-cloudComputing/degreeCentrality02.png)
...
![clique img](/2017-02-25-cloudComputing/community01.png)
...
![Information Diffusion](/2017-02-25-cloudComputing/InformationDiffusion.png)
