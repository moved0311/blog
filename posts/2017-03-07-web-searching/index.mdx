...
- [Multinomial model](https://en.wikipedia.org/wiki/Multinomial_distribution)  
   ![multinomial Distribustion](/2017-03-07-webSearching/MultinomialDistribution.png)
...
example:
k = 3
![kNN = 3](/2017-03-07-webSearching/kNN3.png)
...
目標是找到最大的$\rho$
![svm01](/2017-03-07-webSearching/svm01.png)
...
![svm02](/2017-03-07-webSearching/svm02.png)
