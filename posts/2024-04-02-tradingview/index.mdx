...
| --------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------- |
| <img src="/2024-04-02-tradingview/lightweight-charting.png" style={{height:'300px'}} /> | <img src="/2024-04-02-tradingview/charting_library.png" style={{height:'300px'}}/> |
...
2. 從[charting_library](https://github.com/tradingview/charting_library/)下載`charting_library` 與 `datafeeds` 放到`/public`下
   ...
   <img src="/2024-04-02-tradingview/put-to-public.png" alt="static-files" width="600" />
...
- symbol: symbol 格式可以根據 API 不同來做改變
  ...
  <img src="/2024-04-02-tradingview/AAPL.png" alt="tradingview-first-example" width="400" />
...
<img src="/2024-04-02-tradingview/flow.png" alt="flow" />
